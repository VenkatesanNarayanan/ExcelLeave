use utf8;
package ExcelLeave::Schema::Result::LeaveRequest;
...
Related object: L<ExcelLeave::Schema::Result::LeaveRequestBatch>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PxJ6bG+x/vitYeq+IXh4rQ
